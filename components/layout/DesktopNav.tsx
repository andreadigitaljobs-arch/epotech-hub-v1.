      ...
      <div className="bg-slate-900 rounded-[2.5rem] flex-1 flex flex-col p-8 shadow-2xl shadow-blue-900/20 border border-white/5 relative overflow-hidden group">
        ...
        <div className="mb-8 flex items-center gap-4 relative z-10">
          <div className="relative">
            ...
            <Image src="/logo.png" alt="Epotech" width={44} height={44} className="rounded-full relative border border-white/20 shadow-2xl" />
          </div>
        ...
        <div className="flex-1 space-y-6 relative z-10 overflow-y-auto no-scrollbar">
              ...
              {primaryNav.map((item) => {
                ...
                return (
                  <Link
                    key={item.path}
                    href={item.path}
                    className={`flex items-center gap-4 rounded-2xl px-5 py-2.5 text-[10px] font-black uppercase tracking-widest transition-all duration-500 group/item relative ${
                      isActive
                  ...
                  >
                    {isActive && (
                      <div className="absolute left-0 w-1 h-5 bg-blue-500 rounded-full -translate-x-1"></div>
                    )}
          ...
          <div>
            ...
            <nav className="space-y-1.5">
              <Link
                href="/manual"
                className={`flex items-center gap-4 rounded-2xl px-5 py-2.5 text-[10px] font-black uppercase tracking-widest transition-all duration-500 group/item ${
                  pathname === "/manual"
