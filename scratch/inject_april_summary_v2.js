...
async function injectData() {
  console.log('Actualizando Resumen Mensual con datos verificados (+5 seguidores)...');
  ...
  if (error) {
    ...
    console.log('¡Éxito! Datos verificados inyectados correctamente.');
  }
}
